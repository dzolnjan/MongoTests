...
namespace MongoDB.Bson
{
    ...
    /// </summary>
    [Serializable]
    public struct ObjectIdHelper : IComparable<ObjectIdHelper>, IEquatable<ObjectIdHelper>
    {
        // private static fields
        private static ObjectIdHelper __emptyInstance = default(ObjectIdHelper);
        ...
        public ObjectIdHelper(byte[] bytes)
        {
            if (bytes == null)
            {
        ...
        internal ObjectIdHelper(byte[] bytes, int index)
        {
        ...
        public ObjectIdHelper(DateTime timestamp, int machine, short pid, int increment)
        ...
        /// <param name="pid">The PID.</param>
        /// <param name="increment">The increment.</param>
        public ObjectIdHelper(int timestamp, int machine, short pid, int increment)
        {
        ...
        /// </summary>
        public static ObjectIdHelper Empty
        {
        ...
        public static bool operator <(ObjectIdHelper lhs, ObjectIdHelper rhs)
        {
        ...
        public static ObjectIdHelper GenerateNewId()
        {
        ...
        /// <returns>An ObjectId.</returns>
        public static ObjectIdHelper GenerateNewId(int timestamp)
        {
            int increment = Interlocked.Increment(ref __staticIncrement) & 0x00ffffff; // only use low order 3 bytes
            return new ObjectIdHelper(timestamp, __staticMachine, __staticPid, increment);
        }
        ...
        {
            var __unixEpoch = new DateTime(1970, 1, 1, 0, 0, 0, DateTimeKind.Utc);
        ...
        public int CompareTo(ObjectIdHelper other)
        {
        ...
        /// <param name="rhs">The other ObjectId.</param>
        /// <returns>True if the two ObjectIds are equal.</returns>
        public bool Equals(ObjectIdHelper rhs)
        {
            return
                _a == rhs._a &&
                _b == rhs._b &&
        ...
        {
            if (obj is ObjectIdHelper)
            {
                return Equals((ObjectIdHelper)obj);
            }
            else
            {
                return false;
